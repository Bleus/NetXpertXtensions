...
namespace NetXpertCodeLibrary
{
    ...
    public sealed class TreeGroupChain
    {
        ...
        public string this[int index]
		{
            get
			{
                if ( index.InRange( Count, 0, NetXpertExtensions.Classes.Range.BoundaryRule.Loop ) ) return Parts[ index ];
    ...
    public abstract class DataTreeRoot<T> : DataTree<T>
    {
        ...
        {
            string raw = $"{XML.HEADER}<{this._xmlRootTag} name='{Name}' groupTag='{XmlGroupTag}'>";
